...
% function input:   adjacency matrix (3d for multiple subjects/groups)
% online input:     none
%
% output: gr structure
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   TO DO
%   - add binary undirected networks
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for n = 1:nsubjs
    ...
    gr.local_efficiency(n,:) = efficiency_wei(W(:,:,n),2)';
